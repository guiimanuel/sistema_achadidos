                    ...
                    {currentUser ? (
                        <View style={styles.tabs}>
                            <Pressable
                                ...
                                style={[
                                    styles.tab,
                                    activeTab === "mural" ? styles.tabActive : styles.tabInactive,
                                ]}
                            ...
                            <Pressable
                                ...
                                style={[
                                    styles.tab,
                                    activeTab === "mine" ? styles.tabActive : styles.tabInactive,
                                ]}
            ...
            <View style={styles.topBar}>
                <View style={styles.topBarRow}>
                    ...
                    >
                        {currentUser ? (
                            ...
                            <>
                                <Ionicons name="log-in-outline" size={20} color={colors.green_primary} />
                ...
                {currentUser && profileMenuOpen ? (
                    <Pressable style={styles.logoutPopover} onPress={handleSignOut}>
                        <Ionicons name="log-out-outline" size={22} color="#7b2b2b" />
